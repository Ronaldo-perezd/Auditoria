...
$(function () {
    ...
    $demoSettings.append(
        ...
        + '</label>'
        + '<p>Alternar el estado de las barras laterales izquierdas (abrir o contraer)</p>'
        + '</div>'
        ...
        + '</label>'
        + '<p>Alterna entre las pieles oscuras y claras para la barra lateral derecha</p>'
        + '</div>'
    )
